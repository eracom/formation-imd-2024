...
- Logiciel design d'interface ([Figma](https://code.eracom-pedagogique.ch/infos-profs-imd/80-figma.html)): ce cours devrait donner une place à l'apprentissage d'un logiciel de design d'interface (pour les FPC: en coordination avec le cours EP *Design d'interfaces 1*).
...
- [reverse-engineer an interface](https://designbriefs.ch/reverse-engineer-an-interface/)
...
- *[Typo et design pour écran](https://pyramyd-editions.com/products/typo-et-design-pour-ecran)*, Ellen Lupton, Pyramyd, 2015 (traduction de: *Type on Screen*, 2014).
