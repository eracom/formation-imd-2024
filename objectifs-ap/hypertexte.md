...
Ce cours a pour objectif de compléter par des applications pratiques le cours CP de Typographie. 

Il s'agit donc de travailler sur des projets mettant en œuvre du texte et de la typographie, avec une orientation vers les écrans et le numérique (d'où le nom "Projet Hypertexte").
