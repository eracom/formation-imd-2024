...
Pour les apprentis en école, ce cours fonctionne en parallèle au "[Projet App Mobile](../objectifs-ap/interface-app-mobile.html)", qui est focalisé sur les phases *recherche* et *concept*, le design, les tests utilisateur.
...
- Coder une _Landing page_ (page promotionnelle) responsive.
...
- Jeremy Keith, _[Going Offline](https://abookapart.com/products/going-offline)_, A Book Apart, 2018. Petit livre expliquant les enjeux d'une Progressive Web App.
- Conférence de Jeremy Keith: _[Any Site can be a Progressive Web App](https://speaking.adactio.com/d1zSa7)_, 2018.
