---
title: Développement d'interfaces 3 - Interactions
layout: cours
type: 30-EP
code: ID-CP-DEV3
cursus:
...
- Intégration de médias: 3D ([three.js](https://threejs.org/)), [Lottie](https://airbnb.io/lottie/) (animations SVG depuis After Effects)
...
Concepts potentiellement déjà vus avec Processing dans le cours [Projet interface](../objectifs-ap/design-interface.html), en fonction du parcours de la classe:
