---
title: Développement d'interfaces 2 - CSS
layout: cours
type: 30-EP
code: ID-CP-DEV2
periodes: 60
...
- En parallèle avec [Design d'interfaces 3 - Maquettes](design-interfaces-3.html)
- Classes plein-temps: complémentaire avec le cours "[Projet interface (site web)](../objectifs-ap/interface-site-web.html)"
- Classes FPC: en parallèle avec [Développement d'interfaces 3 (Interactions)](dev-interfaces-3.html)
...
- Support de cours CSS : [https://cours-web.ch/css/](https://cours-web.ch/css/)
- Support de cours Git : [https://cours-web.ch/git/](https://cours-web.ch/git/)
- Github Education : [https://education.github.com/](https://education.github.com/)
- Github Classrooms : [https://classroom.github.com/classrooms](https://classroom.github.com/classrooms)
